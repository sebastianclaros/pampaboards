...
const Footer = () => (
    <footer className="bg-white dark:bg-gray-900">
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
            <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 Proyecto para el Colegio Labarden.
            </span>
            <div className="flex mt-4 space-x-5 sm:justify-center sm:mt-0">
                <a href="https://www.facebook.com/pampaboards.oficiall" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                    <svg className="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 8 19">
                            <path d="M6.135 3H8V0H6.135a4.147 4.147 0 0 0-4.142 4.142V6H0v3h2v9.938h3V9h2.021l.592-3H5V3.591A.6.6 0 0 1 5.592 3h.543Z"/>
                        </svg>
                    <span className="sr-only">Facebook page</span>
                </a>
                <a href="https://www.twiter.com/pampaboards.oficiall" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                ...
                <a href="https://www.instagram.com/pampaboards.oficiall/" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
